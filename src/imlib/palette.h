...
class palette : public linked_node
{
  ...
  public:
    ...
    unsigned int red(int x)
    {
        return pal[x].red;
    }
    unsigned int green(int x)
    {
        return pal[x].green;
    }
    unsigned int blue(int x)
    {
        return pal[x].blue;
    }
    void *addr()
...
class quant_node : public linked_node
{
  ...
  public:
    ...
    quant_node(int level, quant_node *dad, unsigned char r = 0, unsigned char g = 0, unsigned char b = 0);

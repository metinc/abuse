...
#define VECTOR_OP(elems, op)                                                                                           \
    template <typename U> inline Vec##elems<T> operator op(Vec##elems<U> const &val) const                             \
    {                                                                                                                  \
        Vec##elems<T> ret;                                                                                             \
        ...
        return ret;                                                                                                    \
                                                                                                                       ...
                                                                                                                       \
    template <typename U> inline Vec##elems<T> operator op##=(Vec##elems<U> const &val)                                \
    {                                                                                                                  \
...
#if !defined __ANDROID__
    template <typename U> friend std::ostream &operator<<(std::ostream &stream, Vec2<U> const &v);
#endif
...
#if !defined __ANDROID__
    template <typename U> friend std::ostream &operator<<(std::ostream &stream, Vec3<U> const &v);
#endif
...
#if !defined __ANDROID__
    template <typename U> friend std::ostream &operator<<(std::ostream &stream, Vec4<U> const &v);
#endif
...
#define SCALAR_GLOBAL(elems, op, U)                                                                                    \
    template <typename T> static inline Vec##elems<U> operator op(U const &val, Vec##elems<T> const &that)             \
    {                                                                                                                  \
        Vec##elems<U> ret;                                                                                             \
        for (int n = 0; n < elems; n++)                                                                                \
            ret[n] = val op that[n];                                                                                   \
...
template <typename T> struct Mat4
{
    ...
    inline Vec4<T> &operator[](int n)
    {
        return v[n];
    }
    inline Vec4<T> const &operator[](int n) const
    {
        return v[n];
    }
...
#if !defined __ANDROID__
    template <class U> friend std::ostream &operator<<(std::ostream &stream, Mat4<U> const &m);
#endif

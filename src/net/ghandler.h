...
{
  public:
    virtual int process_net()
    {
        return 1;
    } // return 0 if net-shutdown need to happen
    virtual void add_engine_input()
    {
        base->input_state = INPUT_PROCESSING;
    }
    virtual int input_missing()
    {
        return 1;
    ...
    virtual int end_reload(int disconenct = 0)
    {
        return 1;
    }
    ...
    {
        return 1;
    } // should disconnect from everone and close all sockets

            ...
            for (light_source *f = first_light_source; f; f = f->next)
            {
                    ...
                    f->y - vy <= (v->m_bb.y - v->m_aa.y + 1))
                {
                    ...
                    main_screen->Rectangle(ivec2(f->x1 - vx, f->y1 - vy) + v->m_aa,
                                           ivec2(f->x2 - vx, f->y2 - vy) + v->m_aa, wm->medium_color());
                }
            }
        }
                            ...
                            new button(bw * 1, bh * 1, DEV_LIGHT4, cache.img(light_buttons[4]),
                                       new button(bw * 2, bh * 1, DEV_LIGHT5, cache.img(light_buttons[5]),
                                                  new button(bw * 0, bh * 2, DEV_LIGHT6, cache.img(light_buttons[6]),
                                                             new button(
                                                                 bw * 1, bh * 2, DEV_LIGHT7,
                                                                 cache.img(light_buttons[7]),
                                                                 new button(
                                ...
                                new text_field(
                                    ...
                                    new text_field(
                                        ...
                                        new text_field(
                                            ...
                                            new text_field(
                                                wl, wh + th * 7,
                                                DEV_AI_MORPHPR, symbol_str("ai_morph"), "####", (double)o->mp(),
                                                new text_field(
                                                    wl, wh + th * 8, DEV_AI_TYPE, symbol_str("ai_type"), "####",
                                                    (double)o->aitype(),
                                                    new text_field(wl, wh + th * 9, DEV_AI_STATE,
                                                                   symbol_str("ai_state"), "####", (double)o->aistate(),
...
void dev_controll::area_handle_input(Event &ev)
{
    ...
    if (ev.type == EV_MOUSE_BUTTON && ev.mouse_button)
    {
        ...
        if (!current_level)
            return;
        current_area = current_level->area_list = new area_controller(
            pos.x, pos.y, the_game->ftile_width(), the_game->ftile_height(), current_level->area_list);
        the_game->need_refresh();
                            ...
                            new text_field(
                                ...
                                new text_field(
                                    ...
                                    new text_field(wl, wh + th * 4, DEV_AREA_VIEW_YOFF, symbol_str("a_view_yoff"),
                                                   ...
                                                   new text_field(
                                                       wl, wh + th * 5, DEV_AREA_VIEW_XOFF_SPEED,
...
void dev_controll::handle_event(Event &ev)
{
                    ...
                    oedit = wm->CreateWindow(
                        ...
                        new button_box(
                            ...
                            new button(
                                ...
                                new button(
                                    bw * 1, 0, DEV_OEDIT_MOVE, cache.img(dev_move),
                            ...
                            new button(
                                ...
                                new button_box(bw * 1, bh * 1, DEV_OEDIT_CHAR_BOX, 0,
                                               new button(bw * 1, bh * 1, DEV_OEDIT_LEFT, cache.img(dev_char_left),
                                                          new button(bw * 2, bh * 1, DEV_OEDIT_RIGHT,
                                                                     cache.img(dev_char_right), NULL)),
                ...
                else if (selected_light)
                {
                    ...
                    ledit = wm->CreateWindow(
                        ...
                        new button_box(
                            0, 0, ID_NULL, 1,
                            new button(
                                bw * 0, 0, DEV_LEDIT_OK, cache.img(dev_ok),
            ...
            if (!mess_win)
            {
                ...
                mess_win = wm->CreateWindow(
                    ...
                    new text_field(
                        ...
                        new text_field(
                            0, h * 1, ID_MESS_STR2, symbol_str("ap_height"), "****", 2,
                            new text_field(
                                0, h * 2, ID_MESS_STR3, symbol_str("ap_name"), "***********", "pal",
    ...
    case EV_KEY: {
        ...
        if (ev.window == NULL || ev.window == pmenu || ev.window == forew ||
            is_pal_win(ev.window)) // main window actions
        {
            switch (ev.key)
            {
            case JK_CTRL_L:
                ...
                for (xx = tile.x; xx < tile.x + w; xx++)
                {
                    for (yy = tile.y; yy < tile.y + h; yy++)
                    {
                        if (xx >= 0 && yy >= 0 && xx < current_level->foreground_width() &&
                            ...
                            the_game->PutFg(ivec2(xx, yy), raise_all
                                                               ? make_above_tile(pat[xx - tile.x + (yy - tile.y) * w])

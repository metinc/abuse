...
LObject *l_undefined;
LSymbol *true_symbol = NULL, *list_symbol, *string_symbol, *quote_symbol, *backquote_symbol, *comma_symbol, *do_symbol,
        *in_symbol, *aref_symbol, *if_symbol, *progn_symbol, *car_symbol, *cdr_symbol;

void *colon_initial_contents, *colon_initial_element, *eq_symbol, *zero_symbol, *eq0_symbol, *load_warning;

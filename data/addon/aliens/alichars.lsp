...
;; Custom weapon type 50, dispatched by the shared fire_object function.
(defun alien_fire_object (creator x y angle target)
  (with_object (add_object SHOTGUN_BULLET x y)
    (progn
      (play_sound ALSLASH_SND 127 (x) (y))
      (setq sgb_lifetime 6)
      (setq sgb_speed 15)

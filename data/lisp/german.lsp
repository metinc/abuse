...
;; Weitere Einzelheiten zu den Benutzerrechten unter Lizenzrechte.
 ...
 (setq max_error       "Max Spielerzahl sollte gleich oder mehr als Min Spielerzahl sein ") ; V-C changed
	 ...
	 (setq connection_type "Verbindung")
	 (setq local_game      "Lokal")
	 (setq online_game     "Online")
	 (setq streamer_mode   "Streamer-Modus")
	 ...
	 (setq host_ended_server "Der Host hat den Server beendet.")
         ...
         (setq online_ready "Teile den Raumcode %s,\nund starte das Spiel, wenn du bereit bist.")
	 ...
	 (setq lobby_title "Mehrspieler-Lobby")
	 (setq lobby_players "Es sind %d Spieler verbunden.")
	 (setq online_lobby_players "Raumcode: %s\nEs sind %d Spieler verbunden.")
	 (setq online_lobby_players_streamer "Raumcode beim Streamen verborgen.\nEs sind %d Spieler verbunden.")
	 (setq client_lobby_players "Es sind %d Spieler verbunden.\nWarte darauf, dass der Host die Runde startet.")
         ...
         (setq join_online     "Onlinespiel beitreten")
	 ...
	 (setq ic_editor         "Level-Editor")
         (setq language          "Sprache")
         (setq language_english  "Englisch")
         (setq language_german   "Deutsch")
         (setq language_french   "Französisch")
	 (setq player_lower_skin "Unterkörper-Skin")
	 (setq player_upper_skin "Oberkörper-Skin")
	 (setq skin_standard     "Standard")
	 (setq skin_blue         "Blau")
	 (setq skin_yellow       "Gelb")
	 (setq skin_fire         "Feuer")
	 (setq skin_olive        "Oliv")
	 (setq skin_pink         "Rosa")
	 (setq skin_darkblue     "Dunkelblau")
	 (setq skin_purple       "Violett")
	 (setq skin_africa       "Afrika")
	 (setq skin_gold         "Gold")
	 (setq skin_land         "Land")

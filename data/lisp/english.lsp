...
(select section
	('game_section
	 ...
	 (setq last_packet_age    "Time since last packet")
	 (setq host_player        "Host")
	 (setq player_status      "Player status")
	 ...
	 (setq ant_hide           "hidden (1=true,0=false)")
	 ...
	 (setq rob_hide           "hidden start (1=hidden,0=visible)")
	 ...
	 (setq dimmer_silent      "silent mode (1=yes,0=no)")
	 ...
	 (defun get_train_msg (message_num)
	   (select message_num
		   ...
		   (6 "Use the mouse wheel or keys 1 to 7 to select weapons")
	 ...
	 (setq streamer_mode   "Streamer mode")
	 ...
	 (setq online_ready "Share room code %s,\nthen start the game when ready.")
	 (setq online_ready_streamer "Room code hidden for streaming.\nCopy it to share privately.\nStart the game when ready.")
	 (setq start_game_button "Start game")
	 (setq coop_lobby_title "Co-op")
	 (setq deathmatch_lobby_title "Deathmatch")
	 (setq coop_lobby_instructions "The level is complete once at least one\nplayer reaches the goal.\nSave consoles can only be used while\nall players are alive.\nPick-ups are automatically shared\nwith all players.\nStay together so no one gets trapped\nalone in a room.\nThe host can load the last save at any time\nfrom the main menu.\nPress TAB to toggle room code and highscores.")
	 (setq deathmatch_lobby_instructions "The first player to score %d kills wins.\nEvery player is an enemy.\nWeapons and ammo respawn.\nPress TAB to toggle room code and highscores.")
	 (setq lobby_players "Players connected: %d")
	 (setq online_lobby_players "Room code: %s\nPlayers connected: %d")
	 (setq online_lobby_players_streamer "Room code hidden for streaming.\nPlayers connected: %d")
	 ...
	 (setq player_lower_skin "Lower body skin")
	 (setq player_upper_skin "Upper body skin")

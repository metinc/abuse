...
(setq telep_msg "Appuyez sur la flèche bas pour vous téléporter")
	 ...
	 (setq streamer_mode   "Mode streaming")
...
(setq max_players     "Ce serveur est complet.\nVeuillez réessayer plus tard.")
	 ...
	 (setq host_ended_server "L’hôte a fermé le serveur.")
         ...
         (setq online_ready "Partagez le code %s,\npuis démarrez quand vous êtes prêt.")
	 ...
	 (setq lobby_title "Salon multijoueur")
	 (setq lobby_players "%d joueur(s) connecté(s).")
	 (setq online_lobby_players "Code du salon : %s\n%d joueur(s) connecté(s).")
	 (setq online_lobby_players_streamer "Code masqué pour le streaming.\n%d joueur(s) connecté(s).")
	 (setq client_lobby_players "%d joueur(s) connecté(s).\nEn attente du lancement de la partie par l’hôte.")
	 ...
	 (setq player_lower_skin "Apparence du bas du corps")
	 (setq player_upper_skin "Apparence du haut du corps")
